...
namespace ProjectPBF.Migrations
{
    ...
    [Migration("20260625111327_AddWorldEventsAndEffects")]
    partial class AddWorldEventsAndEffects
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectPBF.Models.CalendarEventModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectPBF.Models.ConflictRuleRowModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConflictRuleId");

                    b.HasIndex("ConflictRuleId", "Order");

                    b.ToTable("ConflictRuleRows");
                });
            ...
            modelBuilder.Entity("ProjectPBF.Models.MissionProposalModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SuggestedRewards")
                        .HasMaxLength(3000)
                        .HasColumnType("nvarchar(3000)");
                    ...
                    b.ToTable("MissionProposals");
                });

            modelBuilder.Entity("ProjectPBF.Models.MissionReviewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MissionProposalId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MissionProposalId");

                    b.HasIndex("ReviewerId");

                    b.HasIndex("MissionProposalId", "ReviewerId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ProjectPBF.Models.ConflictRuleRowModel", b =>
                {
                    b.HasOne("ProjectPBF.Models.ConflictRuleModel", "ConflictRule")
                        .WithMany("Rows")
                        .HasForeignKey("ConflictRuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ConflictRule");
                });
            ...
            modelBuilder.Entity("ProjectPBF.Models.MissionProposalModel", b =>
                {
                    b.HasOne("ProjectPBF.Models.CampaignModel", "Campaign")
                        .WithMany("MissionProposals")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectPBF.Models.UserModel", "SubmittedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectPBF.Models.MissionReviewModel", b =>
                {
                    b.HasOne("ProjectPBF.Models.MissionProposalModel", "MissionProposal")
                        .WithMany("Reviews")
                        .HasForeignKey("MissionProposalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjectPBF.Models.UserModel", "Reviewer")
                        .WithMany()
                        .HasForeignKey("ReviewerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("MissionProposal");
            ...
            modelBuilder.Entity("ProjectPBF.Models.CampaignModel", b =>
                {
                    ...
                    b.Navigation("ConflictRules");

                    b.Navigation("ItemTemplates");

                    b.Navigation("Members");

                    b.Navigation("MissionProposals");
